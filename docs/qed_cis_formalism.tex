...
the full linear-response (RPA/TDHF) generalisation with de-excitation
amplitudes, for which the prism of approximations of
Refs.~\cite{Yang2021, Yang2022} is the intended target; and multi-mode
cavities.
