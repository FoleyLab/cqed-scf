...
# Example Cavity parameters (using a single lambda magnitude for this script)
omega = 0.06615
lam_mag = 0.1
# Hardcoded direction vector based on your script's logic
...
print(f"Using lambda vector: {lambda_vector}")

# ==========================================
# 2. PARSE INITIAL GEOMETRY
# ==========================================

# We will parse your string directly into ASE format
ortho_string = """
1 1
