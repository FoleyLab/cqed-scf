...
#total_sapt0 = psi4.variable('SAPT0 ENERGY')

print(f"Electrostatics: {elst: .8f} Hartrees")
print(f"Exchange:       {exch: .8f} Hartrees")
print(f"Induction:      {ind: .8f} Hartrees")
print(f"Dispersion:     {disp: .8f} Hartrees")
print(f"Total SAPT0:    {e_sapt: .8f} Hartrees")
